# Новое распространение: 3 должности ассистентов по престарелым.

- **Профессия (ES):** Nueva difusión: 3 puestos de auxiliar de geriatría
- **Оригинальное название:** Nueva difusión: 3 puestos de auxiliar de geriatría (ref. 4136)
